    ...
    <div className="modal-overlay" style={overlayStyle} onClick={onClose}>
      <div className="modal-card" style={cardStyle} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--color-border)', paddingBottom: '12px', marginBottom: '15px' }}>
          ...
          <button 
            onClick={onClose} 
            style={{ background: 'none', border: 'none', fontSize: '1.2rem', cursor: 'pointer', color: 'var(--color-muted)' }}
          >
            ✖
          </button>
        </div>
        ...
        <div>
          ...
          <p><strong>Profesor:</strong> {evento.profesor}</p>
          <p>
          ...
          <p style={{ fontWeight: '600', marginBottom: '6px' }}>Comentarios de la Evaluación:</p>

...
import '../../styles/styles-teacher/PerfilDocente.css'; 

const PerfilTeacher = () => {
  const [data, setData] = useState({
    teacher: null,
    statistics: { totalStudents: 0, totalEvaluations: 0, averageRating: 0 }
  });
      ...
      <main className="main-content">
        ...
        <div className="profile-container">
          <div className="stats-grid">
            <StatCard title="Estudiantes a cargo" value={data.statistics?.totalStudents ?? 0} icon={<Users size={24} />} />
            <StatCard title="Evaluaciones"         value={data.statistics?.totalEvaluations ?? 0} icon={<Award size={24} />} />
            <StatCard title="Rating Promedio"      value={data.statistics?.averageRating ?? '0.0'} icon={<Clock size={24} />} />
          </div>
        </div>

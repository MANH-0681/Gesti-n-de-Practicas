...
import '../../styles/styles-supervisor/sidebar.css'; // Asegúrate de tener este archivo CSS para los estilos de la barra lateral
  ...
  return (
	...
	<GraduationCap
      ...
      <nav className="sidebar-menu">
        <NavLink to="/inicio-supervisor" className={({ isActive }) => (isActive ? 'active' : '')}>
          <LayoutDashboard size={20} />
          Dashboard
        </NavLink>

        <NavLink to="/PerfilSupervisor" className={({ isActive }) => (isActive ? 'active' : '')}>
          <UserCircle size={20} />
          Perfil
        </NavLink>

        <NavLink to="/practicas-supervisor" className={({ isActive }) => (isActive ? 'active' : '')}>
          <FileText size={20} />
          Practicas
        </NavLink>
